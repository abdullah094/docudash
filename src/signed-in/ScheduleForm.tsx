...
const ScheduleForm = () => {
  const navigation = useNavigation<DocumentNavigationProps<"ScheduleForm">>();
  const route = useRoute<DocumentRouteProps<"ScheduleForm">>();
  ...
  return (
    ...
    >
      ...
      <View style={styles.input_view}>
        <Text style={styles.input_heading}>Date</Text>
        <TextInput
          style={styles.input}
          placeholder={date}
          editable={false}
